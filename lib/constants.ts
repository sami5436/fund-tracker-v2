...
export const FUNDS: FundConfig[] = [
  ...
  },
  {
    ...
    totalTop10Weight: 66.77,
    residualProxy: 'IWF',
    holdings: [
      { ticker: 'NVDA',  name: 'NVIDIA',    weight: 12.43 },
      { ticker: 'GOOGL', name: 'Alphabet',   weight: 9.98  },
      { ticker: 'TSLA',  name: 'Tesla',      weight: 7.51  },
      { ticker: 'AMZN',  name: 'Amazon',     weight: 6.93  },
      { ticker: 'META',  name: 'Meta',       weight: 6.86  },
      { ticker: 'NFLX',  name: 'Netflix',    weight: 5.44  },
      { ticker: 'BA',    name: 'Boeing',     weight: 4.98  },
      { ticker: 'V',     name: 'Visa',       weight: 4.60  },
      { ticker: 'ORCL',  name: 'Oracle',     weight: 4.02  },
      { ticker: 'MSFT',  name: 'Microsoft',  weight: 4.02  },
    ],
  },
  {
    id: 'fsrpx',
