...
export const FUNDS: FundConfig[] = [
  ...
  },
  {
    ...
    totalTop10Weight: 67.70,
    residualProxy: 'IWF',
    holdings: [
      { ticker: 'NVDA',  name: 'NVIDIA Corp',                weight: 12.64 },
      { ticker: 'GOOGL', name: 'Alphabet Inc Class A',       weight: 9.52  },
      { ticker: 'TSLA',  name: 'Tesla Inc',                  weight: 8.24  },
      { ticker: 'META',  name: 'Meta Platforms Inc Class A', weight: 6.81  },
      { ticker: 'AMZN',  name: 'Amazon.com Inc',             weight: 6.80  },
      { ticker: 'ORCL',  name: 'Oracle Corp',                weight: 5.40  },
      { ticker: 'BA',    name: 'Boeing Co',                  weight: 4.83  },
      { ticker: 'NFLX',  name: 'Netflix Inc',                weight: 4.81  },
      { ticker: 'V',     name: 'Visa Inc Class A',           weight: 4.38  },
      { ticker: 'MSFT',  name: 'Microsoft Corp',             weight: 4.27  },
    ],
  },
  {
    id: 'fsrpx',
